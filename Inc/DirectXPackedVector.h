...
#pragma GCC diagnostic ignored "-Wpedantic"
        ...
        struct XMCOLOR
        {
            ...
            constexpr XMCOLOR(uint32_t Color) noexcept
                : c(Color)
            {}
        ...
        struct XMHALF2
        {
            ...
            explicit constexpr XMHALF2(uint32_t Packed) noexcept
                : v(Packed)
            {}
            constexpr XMHALF2(HALF _x, HALF _y) noexcept
                : x(_x),
                  y(_y)
            {}
        ...
        struct XMSHORTN2
        {
            ...
            explicit constexpr XMSHORTN2(uint32_t Packed) noexcept
                : v(Packed)
            {}
            constexpr XMSHORTN2(int16_t _x, int16_t _y) noexcept
                : x(_x),
                  y(_y)
            {}
        ...
        struct XMSHORT2
        {
            ...
            explicit constexpr XMSHORT2(uint32_t Packed) noexcept
                : v(Packed)
            {}
            constexpr XMSHORT2(int16_t _x, int16_t _y) noexcept
                : x(_x),
                  y(_y)
            {}
        ...
        struct XMUSHORTN2
        {
            ...
            explicit constexpr XMUSHORTN2(uint32_t Packed) noexcept
                : v(Packed)
            {}
            constexpr XMUSHORTN2(uint16_t _x, uint16_t _y) noexcept
                : x(_x),
                  y(_y)
            {}
        ...
        struct XMUSHORT2
        {
            ...
            explicit constexpr XMUSHORT2(uint32_t Packed) noexcept
                : v(Packed)
            {}
            constexpr XMUSHORT2(uint16_t _x, uint16_t _y) noexcept
                : x(_x),
                  y(_y)
            {}
        ...
        struct XMBYTEN2
        {
            ...
            explicit constexpr XMBYTEN2(uint16_t Packed) noexcept
                : v(Packed)
            {}
            constexpr XMBYTEN2(int8_t _x, int8_t _y) noexcept
                : x(_x),
                  y(_y)
            {}
        ...
        struct XMBYTE2
        {
            ...
            explicit constexpr XMBYTE2(uint16_t Packed) noexcept
                : v(Packed)
            {}
            constexpr XMBYTE2(int8_t _x, int8_t _y) noexcept
                : x(_x),
                  y(_y)
            {}
        ...
        struct XMUBYTEN2
        {
            ...
            explicit constexpr XMUBYTEN2(uint16_t Packed) noexcept
                : v(Packed)
            {}
            constexpr XMUBYTEN2(uint8_t _x, uint8_t _y) noexcept
                : x(_x),
                  y(_y)
            {}
        ...
        struct XMUBYTE2
        {
            ...
            explicit constexpr XMUBYTE2(uint16_t Packed) noexcept
                : v(Packed)
            {}
            constexpr XMUBYTE2(uint8_t _x, uint8_t _y) noexcept
                : x(_x),
                  y(_y)
            {}
        ...
        struct XMU565
        {
            ...
            explicit constexpr XMU565(uint16_t Packed) noexcept
                : v(Packed)
            {}
        ...
        struct XMFLOAT3PK
        {
            ...
            explicit constexpr XMFLOAT3PK(uint32_t Packed) noexcept
                : v(Packed)
            {}
        ...
        struct XMFLOAT3SE
        {
            ...
            explicit constexpr XMFLOAT3SE(uint32_t Packed) noexcept
                : v(Packed)
            {}
        ...
        struct XMHALF4
        {
            ...
            explicit constexpr XMHALF4(uint64_t Packed) noexcept
                : v(Packed)
            {}
        ...
        struct XMSHORTN4
        {
            ...
            explicit constexpr XMSHORTN4(uint64_t Packed) noexcept
                : v(Packed)
            {}
        ...
        struct XMSHORT4
        {
            ...
            explicit constexpr XMSHORT4(uint64_t Packed) noexcept
                : v(Packed)
            {}
        ...
        struct XMUSHORTN4
        {
            ...
            explicit constexpr XMUSHORTN4(uint64_t Packed) noexcept
                : v(Packed)
            {}
            constexpr XMUSHORTN4(uint16_t _x, uint16_t _y, uint16_t _z, uint16_t _w) noexcept
                : x(_x),
                  y(_y),
                  z(_z),
                  w(_w)
        ...
        struct XMUSHORT4
        {
            ...
            explicit constexpr XMUSHORT4(uint64_t Packed) noexcept
                : v(Packed)
            {}
            constexpr XMUSHORT4(uint16_t _x, uint16_t _y, uint16_t _z, uint16_t _w) noexcept
                : x(_x),
                  y(_y),
                  z(_z),
                  w(_w)
        ...
        struct XMXDECN4
        {
            ...
            explicit constexpr XMXDECN4(uint32_t Packed)
                : v(Packed)
            {}
        ...
        struct XM_DEPRECATED XMXDEC4
        {
            ...
            explicit constexpr XMXDEC4(uint32_t Packed) noexcept
                : v(Packed)
            {}
        ...
        struct XM_DEPRECATED XMDECN4
        {
            ...
            explicit constexpr XMDECN4(uint32_t Packed) noexcept
                : v(Packed)
            {}
        ...
        struct XM_DEPRECATED XMDEC4
        {
            ...
            explicit constexpr XMDEC4(uint32_t Packed) noexcept
                : v(Packed)
            {}
        ...
        struct XMUDECN4
        {
            ...
            explicit constexpr XMUDECN4(uint32_t Packed) noexcept
                : v(Packed)
            {}
        ...
        struct XMUDEC4
        {
            ...
            explicit constexpr XMUDEC4(uint32_t Packed) noexcept
                : v(Packed)
            {}
        ...
        struct XMBYTEN4
        {
            ...
            constexpr XMBYTEN4(int8_t _x, int8_t _y, int8_t _z, int8_t _w) noexcept
                : x(_x),
                  ...
                  w(_w)
            {}
            explicit constexpr XMBYTEN4(uint32_t Packed) noexcept
                : v(Packed)
            {}
        ...
        struct XMBYTE4
        {
            ...
            constexpr XMBYTE4(int8_t _x, int8_t _y, int8_t _z, int8_t _w) noexcept
                : x(_x),
                  ...
                  w(_w)
            {}
            explicit constexpr XMBYTE4(uint32_t Packed) noexcept
                : v(Packed)
            {}
        ...
        struct XMUBYTEN4
        {
            ...
            constexpr XMUBYTEN4(uint8_t _x, uint8_t _y, uint8_t _z, uint8_t _w) noexcept
                : x(_x),
                  ...
                  w(_w)
            {}
            explicit constexpr XMUBYTEN4(uint32_t Packed) noexcept
                : v(Packed)
            {}
        ...
        struct XMUBYTE4
        {
            ...
            constexpr XMUBYTE4(uint8_t _x, uint8_t _y, uint8_t _z, uint8_t _w) noexcept
                : x(_x),
                  ...
                  w(_w)
            {}
            explicit constexpr XMUBYTE4(uint32_t Packed) noexcept
                : v(Packed)
            {}
        ...
        struct XMUNIBBLE4
        {
            ...
            explicit constexpr XMUNIBBLE4(uint16_t Packed) noexcept
                : v(Packed)
            {}
            constexpr XMUNIBBLE4(uint8_t _x, uint8_t _y, uint8_t _z, uint8_t _w) noexcept
                : x(_x),
                  y(_y),
                  z(_z),
                  w(_w)
        ...
        struct XMU555
        {
            ...
            explicit constexpr XMU555(uint16_t Packed) noexcept
                : v(Packed)
            {}
...
#pragma warning(pop)
        ...
        float* XMConvertHalfToFloatStream(_Out_writes_bytes_(sizeof(float) + OutputStride * (HalfCount - 1)) float* pOutputStream,
            ...
            _In_ size_t                                                                                             HalfCount) noexcept;
        ...
        HALF*  XMConvertFloatToHalfStream(_Out_writes_bytes_(sizeof(HALF) + OutputStride * (FloatCount - 1)) HALF* pOutputStream,
             ...
             _In_ size_t                                                                                           InputStride,
             _In_ size_t                                                                                           FloatCount) noexcept;
