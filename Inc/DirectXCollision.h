...
#pragma warning(disable : 4324 4820)
    ...
    struct BoundingSphere
    {
        ...
        ContainmentType XM_CALLCONV ContainedBy(_In_ FXMVECTOR Plane0,
            _In_ FXMVECTOR                                     Plane1,
            _In_ FXMVECTOR                                     Plane2,
            _In_ GXMVECTOR                                     Plane3,
            _In_ HXMVECTOR                                     Plane4,
            _In_ HXMVECTOR                                     Plane5) const noexcept;
        ...
        static void CreateFromPoints(_Out_ BoundingSphere&                            Out,
            _In_ size_t                                                               Count,
    ...
    struct BoundingBox
    {
        ...
        static void             CreateFromPoints(_Out_ BoundingBox&                               Out,
                        _In_ size_t                                                               Count,
                        _In_reads_bytes_(sizeof(XMFLOAT3) + Stride * (Count - 1)) const XMFLOAT3* pPoints,
                        _In_ size_t                                                               Stride) noexcept;
    };
    ...
    struct BoundingFrustum
    {
        ...
        constexpr BoundingFrustum(_In_ const XMFLOAT3& origin,
            ...
            _In_ float                                 rightSlope,
            _In_ float                                 leftSlope,
            _In_ float                                 topSlope,
            _In_ float                                 bottomSlope,
        ...
        void GetPlanes(_Out_opt_ XMVECTOR* NearPlane,
            _Out_opt_ XMVECTOR*            FarPlane,
            _Out_opt_ XMVECTOR*            RightPlane,
            _Out_opt_ XMVECTOR*            LeftPlane,
            _Out_opt_ XMVECTOR*            TopPlane,
    ...
    {
        bool XM_CALLCONV Intersects(_In_ FXMVECTOR Origin,
            _In_ FXMVECTOR                         Direction,
            _In_ FXMVECTOR                         V0,
            _In_ GXMVECTOR                         V1,
            _In_ HXMVECTOR                         V2,
            _Out_ float&                           Dist) noexcept;
        // Ray-Triangle

        bool XM_CALLCONV Intersects(_In_ FXMVECTOR A0,
            _In_ FXMVECTOR                         A1,
            _In_ FXMVECTOR                         A2,
            _In_ GXMVECTOR                         B0,
            _In_ HXMVECTOR                         B1,
            _In_ HXMVECTOR                         B2) noexcept;
        // Triangle-Triangle
        ...
        ContainmentType XM_CALLCONV ContainedBy(_In_ FXMVECTOR V0,
            _In_ FXMVECTOR                                     V1,
            _In_ FXMVECTOR                                     V2,
            _In_ GXMVECTOR                                     Plane0,
            _In_ HXMVECTOR                                     Plane1,
            _In_ HXMVECTOR                                     Plane2,
            _In_ CXMVECTOR                                     Plane3,
            _In_ CXMVECTOR                                     Plane4,
